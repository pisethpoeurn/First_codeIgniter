...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="user/index.php">User</a></li>
			<li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Student</a>
			</li>
